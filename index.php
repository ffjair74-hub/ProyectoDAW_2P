...
<head>
  ...
  <link href="/Proyecto_DAW/css/style.css" rel="stylesheet" />
</head>
<body>
  ...
  <header class="header">
      <nav class="nav">
        ...
        <ul class="nav-list">
          ...
          <li><a href="app/views/peliculas/sinopsis.php">Sinopsis</a></li>
          <li><a href="app/views/peliculas/reparto.php">Reparto</a></li>
  ...
  <section id="Galeria" class="slideshow-area">
    ...
    <div class="slideshow-container">
      <article class="movie-slide fade">
        <img src="/Proyecto_DAW/imagenes/principal/saga2007.webp" width=350px alt="Poster Transformers 2007">
        <h4>Transformers (2007)</h4>
        <p>Sam Witwicky descubre que su auto es un Autobot y se ve envuelto en la guerra por el AllSpark.</p>
      </article>

      <article class="movie-slide fade">
        <img src="/Proyecto_DAW/imagenes/principal/saga2009.webp" width=350px alt="Poster Transformers 2009">
      ...
      <article class="movie-slide fade">
        <img src="/Proyecto_DAW/imagenes/principal/saga2011.webp" width=350px alt="Poster Transformers 2011">
        <h4>Dark of the Moon (2011)</h4>
        <p>Una conspiración ligada a la llegada del hombre a la Luna desata una guerra devastadora.</p>
      </article>

      <article class="movie-slide fade">
        <img src="/Proyecto_DAW/imagenes/principal/saga2014.webp" width=350px alt="Poster Transformers 2014">
        <h4>Age of Extinction (2014)</h4>
        <p>Un inventor descubre a Optimus y surge una nueva amenaza con los Dinobots.</p>
      </article>

      <article class="movie-slide fade">
        <img src="/Proyecto_DAW/imagenes/principal/saga2017.webp" width=350px alt="Poster Transformers 2017">
        <h4>The Last Knight (2017)</h4>
        <p>La historia secreta de los Transformers en la Tierra sale a la luz.</p>
      </article>

      <article class="movie-slide fade">
        <img src="/Proyecto_DAW/imagenes/principal/saga2018.webp" width=350px alt="Poster Bumblebee 2018">
        <h4>Bumblebee (2018)</h4>
        <p>Precuela emotiva ambientada en los años 80.</p>
      </article>

      <article class="movie-slide fade">
        <img src="/Proyecto_DAW/imagenes/principal/saga2023.webp" width=350px alt="Poster Rise of the Beasts 2023">
